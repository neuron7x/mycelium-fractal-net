...
- **Causal Validation Gate** — 41 falsifiable rules verify that every pipeline conclusion follows from data. Perturbation stability tested with 3 noise seeds. Reports are blocked if causal consistency fails.
