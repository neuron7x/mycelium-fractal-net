...
SimulationSpec
  ...
  simulate ──→ FieldSequence(NxN, T steps, V ∈ [-95, +40] mV)
     ...
     │
     ▼
  Causal Validation Gate ──→ 46 rules across 7 stages
     │
     ▼
...
46 rules organized across 7 stages:

| Stage | Rules | What is verified |
|-------|-------|-----------------|
| **SIM** | 11 | Field bounds, NaN/Inf, CFL stability, occupancy conservation, MWC monotonicity |
| **EXT** | 7 | Embedding validity, descriptor completeness, feature-group integrity, fractal quality |
| **DET** | 8 | Score bounds, label vocabulary, confidence range, evidence consistency |
| **FOR** | 7 | Horizon validity, prediction bounds, uncertainty envelope, damping, error monotonicity |
