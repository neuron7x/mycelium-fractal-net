...
# Re-export FeatureVector from package analytics module (single source of truth)
...
assert len(FEATURE_NAMES) == FEATURE_COUNT, (
    f"FEATURE_NAMES length ({len(FEATURE_NAMES)}) must match FEATURE_COUNT ({FEATURE_COUNT})"
)
