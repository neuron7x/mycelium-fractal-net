...
def encrypt_data_adapter(request: EncryptRequest) -> EncryptResponse:
    ...
    try:
        ...
        try:
            ...
            raise CryptoAPIError("Invalid base64-encoded plaintext")
        ...
        if request.associated_data:
            try:
                ...
                raise CryptoAPIError("Invalid base64-encoded associated data")
...
def decrypt_data_adapter(request: DecryptRequest) -> DecryptResponse:
    ...
    try:
        ...
        try:
            ...
            raise CryptoAPIError("Invalid base64-encoded ciphertext")
        ...
        plaintext_bytes = cipher.decrypt(
            ciphertext, associated_data=aad, return_bytes=True
        )
...
def sign_message_adapter(request: SignRequest) -> SignResponse:
    ...
    try:
        ...
        try:
            ...
            raise CryptoAPIError("Invalid base64-encoded message")
...
def verify_signature_adapter(request: VerifyRequest) -> VerifyResponse:
    ...
    try:
        ...
        try:
            ...
            raise CryptoAPIError("Invalid base64-encoded signature")
        ...
        if request.public_key:
            ...
            try:
                ...
                raise CryptoAPIError("Invalid base64-encoded public key")
