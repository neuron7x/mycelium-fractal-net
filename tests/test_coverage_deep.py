...
class TestReactionDiffusionCompat:
    def test_compat_validate_cfl(self) -> None:
        from mycelium_fractal_net.core.reaction_diffusion_compat import compat_validate_cfl_condition
    ...
    def test_compat_activator_inhibitor_step(self) -> None:
        from mycelium_fractal_net.core.reaction_diffusion_compat import compat_activator_inhibitor_step
    ...
    def test_compat_apply_turing_to_field(self) -> None:
        ...
        activator[3, 3] = 1.0
        result, count = compat_apply_turing_to_field(field, activator, threshold=0.5, contribution_v=0.01)
        assert count == 1
        assert result[3, 3] > 0
    ...
    def test_compat_apply_growth_event(self) -> None:
        ...
        result, count = compat_apply_growth_event(field, rng, spike_probability=0.5)
        assert count > 0
    ...
    def test_compat_full_step(self) -> None:
        ...
        f_out, a_out, i_out, stats = compat_full_step(field, a, i, rng, config)
